...
using ShoppingLinkManager.Core.Helpers;
using ShoppingLinkManager.Helpers;
using ShoppingLinkManager.Models;
...
{
    private const string _defaultApplicationDataFolder = "ShoppingLinkManager/ApplicationData";
